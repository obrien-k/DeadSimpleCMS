...
**Status: design phase.** No code yet — see [docs/DESIGN.md](docs/DESIGN.md) for the full design, including why this is a standalone build rather than a Decap CMS fork or plugin.
